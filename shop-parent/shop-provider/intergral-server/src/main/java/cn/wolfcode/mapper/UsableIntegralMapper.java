...
public interface UsableIntegralMapper {
    ...
    UsableIntegral selectIntegralByUserIdForPay(@Param("userId") Long userId, @Param("intergral") Long intergral);

    int decrIntergral(@Param("userId") Long userId, @Param("intergral") Long intergral);
}
